...
# ============================================
# Ralph - Codex Automation Script
# ============================================
# This script automates feature development using OpenAI Codex CLI.
# 
# Prerequisites:
...
codex -p "Read the @plans/plan.md file and generate a prd.json file in the plans directory. \
...
for ((i=1; i<=$1; i++)); do
  ...
  result=$(codex --approval-mode auto-edit -p "@plans/prd.json @progress.txt \
